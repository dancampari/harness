...
```bash
npx github:dancampari/harness#v0.5.1
```
...
```bash
cd your-project
npx github:dancampari/harness#v0.5.1 --yes
npx github:dancampari/harness#v0.5.1 --cli codex --yes
npx github:dancampari/harness#v0.5.1 --cli claude --yes
npx github:dancampari/harness#v0.5.1 --cli cursor --yes
npx github:dancampari/harness#v0.5.1 --cli claude --planning spec-driven --scope project --yes
npx github:dancampari/harness#v0.5.1 --cli codex --planning manual --scope global --yes
```
...
cd your-project
npx github:dancampari/harness#v0.5.1 --yes
npx github:dancampari/harness#v0.5.1 sprint new "implement user auth"
```
...
```bash
npx github:dancampari/harness#v0.5.1 contract propose
npx github:dancampari/harness#v0.5.1 contract approve --role planner
npx github:dancampari/harness#v0.5.1 contract approve --role tester
```
...
```bash
npx github:dancampari/harness#v0.5.1 sprint qa
npx github:dancampari/harness#v0.5.1 sprint qa --accept-screenshots
npx github:dancampari/harness#v0.5.1 sprint qa --accept-fixtures
npx github:dancampari/harness#v0.5.1 sprint repair
npx github:dancampari/harness#v0.5.1 sprint score
npx github:dancampari/harness#v0.5.1 run --resume
```
...
```text
harness   Autonomous Development Pipeline   v0.5.1      Project: harness-demo   Agent: codex   Status: PASS
