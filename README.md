...
```bash
npx github:dancampari/harness#v0.4.9
```
...
```bash
cd your-project
npx github:dancampari/harness#v0.4.9 --yes
npx github:dancampari/harness#v0.4.9 --cli codex --yes
npx github:dancampari/harness#v0.4.9 --cli claude --yes
npx github:dancampari/harness#v0.4.9 --cli cursor --yes
npx github:dancampari/harness#v0.4.9 --cli claude --planning spec-driven --scope project --yes
npx github:dancampari/harness#v0.4.9 --cli codex --planning manual --scope global --yes
```
...
cd your-project
npx github:dancampari/harness#v0.4.9 --yes
npx github:dancampari/harness#v0.4.9 sprint new "implement user auth"
```
...
```bash
npx github:dancampari/harness#v0.4.9 contract propose
npx github:dancampari/harness#v0.4.9 contract approve --role planner
npx github:dancampari/harness#v0.4.9 contract approve --role tester
```
...
```bash
npx github:dancampari/harness#v0.4.9 sprint qa
npx github:dancampari/harness#v0.4.9 sprint qa --accept-screenshots
npx github:dancampari/harness#v0.4.9 sprint qa --accept-fixtures
npx github:dancampari/harness#v0.4.9 sprint repair
npx github:dancampari/harness#v0.4.9 sprint score
npx github:dancampari/harness#v0.4.9 run --resume
```
...
```text
harness   Autonomous Development Pipeline   v0.4.9       Project: harness-demo   Agent: codex   Status: PASS
